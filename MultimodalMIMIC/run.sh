...
python -W ignore main.py  --num_train_epochs 6  --modeltype 'TS_Text' \
                ...
                --gradient_accumulation_steps 4  --num_update_bert_epochs 2 --bertcount 3 \
                --ts_learning_rate  0.0004 --txt_learning_rate 0.00002 \
                --notes_order 'Last' --num_of_notes 5 --max_length 512 --layers 3\
                --output_dir "run/TS_Text/" --embed_dim 128 \
                --model_name "bioLongformer"\
                --task 'ihm'\
                --file_path '/media/ftrujillo/FRD/Projects/UIUC/DLH/CS598_Final/Data/ihm' \
                --num_labels 2 \
                --num_heads 8\
