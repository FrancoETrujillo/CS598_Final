...
def make_save_dir(args):
    ...
    if 'Bert' in args.modeltype:
        ...
        output_dir += str(args.max_length) + "_" + str(args.txt_learning_rate) + "_" + str(args.num_train_epochs) + \
                      "_" + str(args.embed_dim) + "_" + str(args.train_batch_size) + "_" + str(
            args.num_update_bert_epochs) + '/'
        ...
        if "Text" in args.modeltype:
            output_dir += str(args.txt_learning_rate) + "_" + str(args.num_update_bert_epochs) + "_" + str(
                args.bertcount) + "_"
