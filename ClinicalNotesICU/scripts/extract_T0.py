...
for dataset_type in dataset_types:
    ...
    test_path = f"{BENCHMARKS_ROOT_PATH}/data/root/test/"

    train_starttime_path = f"{BENCHMARKS_ROOT_PATH}/data/starttime.pkl"
    test_starttime_path = f"{BENCHMARKS_ROOT_PATH}/data/test_starttime.pkl"

    path = train_path if dataset_type == "train" else test_path
    starttime_path = train_starttime_path if dataset_type == "train" else test_starttime_path
